...
public class Rotatable implements View.OnTouchListener {
	 ...
	 * 如果你的应用程序可以使用多方向，然后你不得不宣布取向转变为可旋转的对象，
	 * 所以它可以重新计算其maxdistances你只需要告知旋转对象取向的变化，当你指定的
	 */
	public void orientationChanged(int newOrientation) {
		...
		// reset maxDistances values to recalculate them重置最大值重新计算
	 ...
	 * 具有给定方向和程度的可旋转物体,使用此方法的其他派生设置持续时间和侦听器
	 */
